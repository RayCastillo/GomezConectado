$(document).ready(function () {
	$(document).on('click',".servicio", function(){ 
        ...
        $('#problemas-box').transition({scale:0.95},100,function() {
        	$('.btn-next').remove();
            $('.page-content').append('<div class="btn-next pulse animated row"> <div class="col-100" style="padding-top:15px;"> <div class="row"> <a class="col-40 btnCancelar back" href="reportar.html">Regresar</a> <a class="col-60 btnNext" href="location.html">Siguiente</a> </div></div></div>');
        });
