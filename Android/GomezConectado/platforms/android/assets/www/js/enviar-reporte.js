...
$(document).on('click','#enviarAC', function(){
    ...
    if(formInstance.isValid()){
        ...
        myApp.alert('Completa el Reporte con tus datos');
    }
});
...
function successBD() {
    ...
    myApp.alert('Actualmente no tienes una conexión a internet. Posteriormente podrás enviar tu reporte.', function(){
