...
$(document).on('click','#shareTwitter', function(){
    window.plugins.socialsharing.shareViaTwitter(titulo, imagefb /* img */,link +' vía @gp_dgo');
});
$(document).on('click','#shareWhats', function(){
  window.plugins.socialsharing.shareViaWhatsApp(titulo, imagefb /* img */, link /* url */, function() {console.log('share ok')}, function(errormsg){alert(errormsg)})
});

$(document).on('click','#shareFB', function(){
    window.plugins.socialsharing.shareViaFacebook(titulo, null , link /* url */, function() {console.log('share ok')}, function(errormsg){alert(errormsg)})
});
